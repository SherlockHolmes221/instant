...
public class HttpUtils {
    ...
    public  static NewsResult getNews(String msg){
    ...
    public static void doGet(final String msg) throws MalformedURLException {
       new Thread(new Runnable() {
           @Override
           public void run() {
               String result = null;
               String url = setParams("top");
